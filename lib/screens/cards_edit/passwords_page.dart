...
class CardsEdit extends StatelessWidget {
  const CardsEdit({Key? key}) : super(key: key);

  static String routeName = "/cardsEdit";  //Setting the route name to "/" makes it the default page so the app starts here
